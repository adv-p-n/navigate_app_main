...
final List<List<Waypoint>> waypoints = [
  [
    gwt1,
    n109c,
    n109cCor,
...
//Floor2
final n207 = Waypoint(name: 'N207', posX: 160, posY: 155);
final n207Cor = Waypoint(name: 'N207-C', posX: 180, posY: 155);

final stairMM2 = Waypoint(name: 'STAIR_MM2', posX: 200, posY: 155);
final stairMM2Cor = Waypoint(name: 'STAIR_MM2-C', posX: 200, posY: 160);

//Floor3
final stairMM3 = Waypoint(name: 'STAIR_MM3', posX: 200, posY: 155);
final stairMM3Cor = Waypoint(name: 'STAIR_MM3-C', posX: 200, posY: 160);

final s307 = Waypoint(name: 'S307', posX: 250, posY: 155);
final s307Cor = Waypoint(name: 'S307-C', posX: 236, posY: 155);

final waypointNotFound = Waypoint(name: 'Waypoint Not Found', posX: 0, posY: 0);
